    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col">
          ...
          <div className="text-3xl font-bold text-slate-900">{stats.totalInvoiced.toLocaleString('ro-RO')} Lei</div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col">
          ...
          <div className="text-3xl font-bold text-slate-900">{stats.totalPaid.toLocaleString('ro-RO')} Lei</div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col">
          ...
          <div className="text-3xl font-bold text-slate-900">{stats.totalUnpaid.toLocaleString('ro-RO')} Lei</div>
        </div>
      </div>
